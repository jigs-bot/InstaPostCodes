...
class Window(QMainWindow): 
	...
	def __init__(self): 
		...
		# setting title 
		self.setWindowTitle("JIGYASHU.PY ")

		self.setStyleSheet("background-image: url(jigyashu.jpg) ;")
	...
	def UiComponents(self): 
		...
		push1.setStyleSheet("background-color : grey")
		...
		push2.setStyleSheet("background-color : grey")
		...
		push3.setStyleSheet("background-color : grey")
		...
		push4.setStyleSheet("background-color : grey")
		...
		push5.setStyleSheet("background-color : grey")
		...
		push6.setStyleSheet("background-color : grey")
		...
		push7.setStyleSheet("background-color : grey")
		...
		push8.setStyleSheet("background-color : grey")
		...
		push9.setStyleSheet("background-color : grey")
		...
		push0.setStyleSheet("background-color : grey")

		# adding operator push button 
		# creating push button 
		push_equal = QPushButton("=", self)

		push_equal.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		...
		push_plus.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		...
		push_minus.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		...
		push_mul.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		...
		push_div.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		...
		push_point.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		...
		push_clear.setStyleSheet("border : 2px solid black;border-radius : 20px;")
		push_clear.setGeometry(5, 100, 200, 40) 

		# del one character button 
		push_del = QPushButton("Del", self)
		push_del.setStyleSheet("border : 2px solid black;border-radius : 20px;")
